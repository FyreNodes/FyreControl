...
@include('partials/admin.settings.nav', ['activeTab' => 'api'])
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
                        <a href="{{ route('admin.settings.api.new') }}" class="btn btn-sm btn-primary">Create New</a>
                    </div>
                </div>
        ...
        $(document).ready(function() {
            $('[data-action="revoke-key"]').click(function (event) {
                ...
                swal({
                    ...
                    $.ajax({
                        method: 'DELETE',
                        url: '/admin/settings/api/revoke/' + self.data('attr'),
                        headers: {
