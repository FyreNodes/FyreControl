...
@section('content-header')
    <h1>Announcements
        <small>You can edit announcements labels.</small>
    </h1>
    <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Edit Announcement Label</h3>
                    <div class="box-tools">
                        <a href="{{ route('admin.announcements') }}">
                            <button type="button" class="btn btn-sm btn-primary" style="border-radius: 0 3px 3px 0;margin-left:-1px;">Go Back</button>
                        </a>
                    </div>
                </div>
                <form method="post" action="{{ route('admin.announcements.labels.update', $label->id)  }}">
                    <div class="box-body">
                        <div class="form-group">
                            <label for="title" class="form-label">Title</label>
                            <input type="text" name="title" id="title" class="form-control" value="{{$label->title}}" />
                        </div>
                        <div class="form-group">
