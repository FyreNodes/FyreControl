...
@section('content')
    <div class="row">
        <div class="col-md-12">
                    ...
                    <div class="box-body row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="image" name="image" value="{{ $plan->image }}">
                            </div>
                    ...
                    <div class="box-body row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="cpu" name="cpu" value="{{ $plan->cpu }}">
                            </div>
                            <div class="form-group">
                                <label for="memory">Plan Memory</label>
                                <input type="text" class="form-control" id="memory" name="memory" value="{{ $plan->memory }}">
                            </div>
                            <div class="form-group">
                                <label for="disk">Plan Disk</label>
                                <input type="text" class="form-control" id="disk" name="disk" value="{{ $plan->disk }}">
                            </div>
                            <div class="form-group">
                                <label for="swap">Plan Swap</label>
                                <input type="text" class="form-control" id="swap" name="swap" value="{{ $plan->swap }}">
                            </div>
                            <div class="form-group">
                                <label for="io">Plan IO</label>
                                <input type="text" class="form-control" id="io" name="io" value="{{ $plan->io }}">
                            </div>
                            <div class="form-group">
                                <label for="databases">Plan Databases</label>
                                <input type="text" class="form-control" id="databases" name="databases" value="{{ $plan->databases }}">
                            </div>
                            <div class="form-group">
                                <label for="backups">Plan Backups</label>
                                <input type="text" class="form-control" id="backups" name="backups" value="{{ $plan->backups }}">
                            </div>
                            <div class="form-group">
                                <label for="allocations">Plan Allocations</label>
                                <input type="text" class="form-control" id="allocations" name="allocations" value="{{ $plan->allocations }}">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <form action="{{ route('admin.billing.plans.delete', $plan->id) }}" method="POST">
                {!! csrf_field() !!}
                {!! method_field('DELETE') !!}
