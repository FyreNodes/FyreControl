...
@section('content-header')
    <h1>Create Instance<small>Add a new instance to the panel.</small></h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="pName">Instance Name</label>
                        ...
                        <div class="form-group">
                            <label for="pUserId">Instance Owner</label>
                            <select id="pUserId" name="owner_id" class="form-control" style="padding-left:0;"></select>
                            <p class="small text-muted no-margin">Email address of the Instance Owner.</p>
                        </div>
                    </div>

                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="pDescription" class="control-label">Instance Description</label>
                            <textarea id="pDescription" name="description" rows="3" class="form-control">{{ old('description') }}</textarea>
                            <p class="text-muted small">A brief description of this instance.</p>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="checkbox checkbox-primary no-margin-bottom">
                                ...
                                <label for="pStartOnCreation" class="strong">Start Instance when Installed</label>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="box">
                ...
                <div class="box-body row">
                    <div class="form-group col-sm-4">
                        ...
                        <p class="small text-muted no-margin">The cluster which this instance will be deployed to.</p>
                    </div>

                    <div class="form-group col-sm-4">
                        <label for="pAllocation">Default Allocation</label>
                        <select id="pAllocation" name="allocation_id" class="form-control"></select>
                        <p class="small text-muted no-margin">The main allocation that will be assigned to this instance.</p>
                    </div>

                    <div class="form-group col-sm-4">
                        <label for="pAllocationAdditional">Additional Allocation(s)</label>
                        <select id="pAllocationAdditional" name="allocation_additional[]" class="form-control" multiple></select>
                        <p class="small text-muted no-margin">Additional allocations to assign to this instance on creation.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="box">
                ...
                <div class="box-body row">
                    <div class="form-group col-xs-6">
                        ...
                        <p class="text-muted small">The total number of databases a user is allowed to create for this instance.</p>
                    </div>
                    <div class="form-group col-xs-6">
                        ...
                        <p class="text-muted small">The total number of allocations a user is allowed to create for this instance.</p>
                    </div>
                    <div class="form-group col-xs-6">
                        ...
                        <p class="text-muted small">The total number of backups that can be created for this instance.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="box">
                ...
                <div class="box-body row">
                    <div class="form-group col-xs-6">
                        ...
                        <p class="text-muted small">This instance will not be allowed to boot if it is using more than this amount of space. If a server goes over this limit while running it will be safely stopped and locked until enough space is available. Set to <code>0</code> to allow unlimited disk usage.</p>
                    </div>
                    ...
                    <div class="form-group col-xs-12">
                        ...
                        <p class="small text-muted no-margin">Terminates the instance if it breaches the memory limits. Enabling OOM killer may cause server processes to exit unexpectedly.</p>
                    </div>
                </div>
            </div>
        </div>
