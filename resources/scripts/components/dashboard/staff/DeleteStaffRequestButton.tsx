...
export default ({ id, onDeleted }: Props) => {
    ...
    return (
        <>
            <ConfirmationModal visible={visible} title={'Delete request?'} buttonText={'Yes, delete request'} onConfirmed={onDelete} showSpinnerOverlay={isLoading} onModalDismissed={() => setVisible(false)}>Are you sure you want to delete this request?</ConfirmationModal>
