...
const Row = styled.div`
    background-color: var(--primary-color); &:hover { background-color: var(--hover-color); } ${tw`flex rounded-sm mb-px text-sm hover:text-neutral-100 cursor-pointer items-center no-underline`};
`;
